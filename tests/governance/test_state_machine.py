...
class TestStateMachine(unittest.TestCase):
    ...
    def test_main_transition_requires_executable_exact_ref_update(self):
        ...
        self.assertIn("distinct pinned protected policy ancestor", conditions)
        self.assertIn("policy/candidate trees", conditions)
        self.assertIn("stage-0 installer", conditions)
